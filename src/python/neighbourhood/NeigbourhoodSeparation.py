...
def get_data(db):
    ...
    save_data_to_file_with_index("HP_separation_neighbourhood", "separation", df.T)


def hp_separation_neighbourhood():
    db = Database(connection_HP)
    prepare_separation_neighbours_table(db)

    prepare_separation_neighbours_table_TEMP(db)
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="0", other_role="1")
    print("1")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="0", other_role="2")
    print("2")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="0", other_role="3")
    print("3")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="0", other_role="4")
    print("4")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="0", other_role="5")
    print("5")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="0", other_role="6")
    print("6")
    ...
    prepare_separation_neighbours_table_TEMP(db)
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="1", other_role="0")
    print("1")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="1", other_role="2")
    print("2")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="1", other_role="3")
    print("3")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="1", other_role="4")
    print("4")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="1", other_role="5")
    print("5")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="1", other_role="6")
    print("6")
    fill_neighbour_separation(db, "1")

    prepare_separation_neighbours_table_TEMP(db)
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="2", other_role="1")
    print("1")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="2", other_role="0")
    print("2")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="2", other_role="3")
    print("3")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="2", other_role="4")
    print("4")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="2", other_role="5")
    print("5")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="2", other_role="6")
    print("6")
    fill_neighbour_separation(db, "2")

    prepare_separation_neighbours_table_TEMP(db)
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="3", other_role="1")
    print("1")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="3", other_role="2")
    print("2")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="3", other_role="0")
    print("3")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="3", other_role="4")
    print("4")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="3", other_role="5")
    print("5")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="3", other_role="6")
    print("6")
    fill_neighbour_separation(db, "3")

    prepare_separation_neighbours_table_TEMP(db)
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="4", other_role="1")
    print("1")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="4", other_role="2")
    print("2")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="4", other_role="3")
    print("3")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="4", other_role="0")
    print("4")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="4", other_role="5")
    print("5")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="4", other_role="6")
    print("6")
    ...
    prepare_separation_neighbours_table_TEMP(db)
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="5", other_role="1")
    print("1")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="5", other_role="2")
    print("2")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="5", other_role="3")
    print("3")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="5", other_role="4")
    print("4")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="5", other_role="0")
    print("5")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="5", other_role="6")
    print("6")
    ...
    prepare_separation_neighbours_table_TEMP(db)
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="6", other_role="1")
    print("1")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="6", other_role="2")
    print("2")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="6", other_role="3")
    print("3")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="6", other_role="4")
    print("4")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="6", other_role="5")
    print("5")
    get_separation_for_role_and_neighbourhood(db, user_mapping="user_mapping_hp", role="6", other_role="0")
    print("6")
